<template>
  <div class="app-container" v-if="$store.state.adminInfo.role_id == 10005">
    <el-row v-permission="238" :gutter="$store.state.isMobile ? 10 : 20" class="panels">
    ...
    <el-row v-permission="240" :gutter="20" class="statistical">
      <el-col :sapn="24">
        <el-card shadow="hover" :body-style="{ padding: 0 }">
          <template #header>
            <div class="statistical-header">
              <div class="type">
                <span class="current_type">订单数</span>
              </div>
    ...
    <el-row :gutter="15" v-permission="239">
      <el-col :md="24" :lg="12" :offset="0">
        <el-card shadow="hover">
          ...
          <el-table :data="RegionRank" border stripe :header-cell-style="{ color: '#2c3e50', backgroundColor: '#f2f2f2' }" id="card-rank">
      ...
      <el-col :md="24" :lg="12" :offset="0">
        <el-card shadow="hover">
          ...
          <el-table :data="storeRank" border stripe :header-cell-style="{ color: '#2c3e50', backgroundColor: '#f2f2f2' }" id="card-rank">
  ...
  <div class="app-container" v-else>
    ...
    <el-row v-permission="55" :gutter="20" class="panels-order">
      <el-card shadow="hover" class="border-0">
        <el-row :gutter="20">
          <el-col :md="12" :lg="6" :offset="0" v-permission="127" @click="$router.push('/goods/order?delivery_status=11')" style="cursor: pointer">
          ...
          <el-col :md="12" :lg="6" :offset="0" v-permission="127" @click="$router.push('/goods/order?pay_status=10')" style="cursor: pointer">
            <p class="key">待付款订单（笔）</p>
            <p class="val">{{ pending.notPay }}</p>
          </el-col>
          <el-col :md="12" :lg="6" :offset="0" v-permission="127" @click="$router.push('/goods/index?sale_out=1')" style="cursor: pointer">
            <p class="key">已售罄商品</p>
        ...
        <el-row :gutter="20">
          ...
          <el-col :md="12" :lg="6" :offset="0" v-permission="127" class="operation-tool">
            <el-link href="/goods/index" :underline="false">
              <p class="operation-tool-icon" style="background: #f15858">
                <el-icon :size="16" color="#fff">
                  <GoodsFilled />
                </el-icon>
              </p>
          ...
          <el-col :md="12" :lg="6" :offset="0" v-permission="127" class="operation-tool">
            <el-link href="/goods/category" :underline="false">
              <p class="operation-tool-icon" style="background: #004c59">
                <el-icon :size="16" color="#fff">
                  <Menu />
                </el-icon>
              </p>
          ...
          <el-col :md="12" :lg="6" :offset="0" v-permission="127" class="operation-tool">
            <el-link href="/system/store" :underline="false">
              <p class="operation-tool-icon" style="background: #139dff">
                <el-icon :size="16" color="#fff">
                  <School />
                </el-icon>
              </p>
          ...
          <template #header>
            <div class="statistical-header">
              <div class="type">
                ...
                <span :class="params.type == 'price' ? 'current_type' : ''" @click="setType('price')">销售额</span>
              </div>
              <div class="date" v-show="!$store.state.isMobile">
                <span :class="params.scope == 'week' ? 'current_scope' : ''" @click="setScope('week')">近7日</span>
                <span :class="params.scope == 'month' ? 'current_scope' : ''" @click="setScope('month')">近30日</span>
    ...
    <el-row :gutter="15" v-permission="55">
      ...
      <el-col :md="24" :lg="8" :offset="0">
        <el-card shadow="hover">
          ...
          <el-table :data="userRank" border stripe :header-cell-style="{ color: '#2c3e50', backgroundColor: '#f2f2f2' }" id="card-rank">
      ...
      <el-col :md="24" :lg="8" :offset="0">
        <el-card shadow="hover">
          ...
          <el-table :data="goodsRank" border stripe :header-cell-style="{ color: '#2c3e50', backgroundColor: '#f2f2f2' }" id="card-rank">
...
home.getData().then((res) => {
  ...
  RegionRank.value = res.result.regionRank || []
  storeRank.value = res.result.storeRank || []
})
...
const getBarData = () => {
  ...
  if (store.state.adminInfo.role_id == 10005) {
    home
